-- Demonstrates the manual approach.
-- The public Postman Echo test credentials are intentionally visible here.
-- Do not use this pattern with real credentials.
...
DECLARE
    ...
    l_username      VARCHAR2(4000) := 'postman';
    l_password      VARCHAR2(4000) := 'password';
    l_basic_token   VARCHAR2(32767);
BEGIN
    l_basic_token :=
    ...
    l_basic_token := REPLACE(REPLACE(l_basic_token, CHR(13), ''), CHR(10), '');
