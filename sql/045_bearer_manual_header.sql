-- Demonstrates a manually supplied Bearer header.
-- abc123 is a non-sensitive test value accepted by the HTTPBin test endpoint.
...
DECLARE
    ...
    l_access_token  VARCHAR2(4000) := 'abc123';
BEGIN
